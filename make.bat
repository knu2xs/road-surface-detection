...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=road-surface-detection
SET SUPPORT_LIBRARY = road_surface_detection
SET ENV_NAME=road-surface-detection
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/road-surface-detection*.tar.bz2
